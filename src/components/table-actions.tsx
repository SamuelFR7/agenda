    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-[160px]">
        ...
        <DropdownMenuItem asChild>
          <Button
            variant="ghost"
            className="flex w-full items-center justify-start gap-2 px-2 font-normal hover:cursor-pointer focus-visible:ring-0"
            onClick={() =>
              window.open(`https://wa.me/${contact.phone1.replace(/\D/g, "")}`)
            }
          >
            <svg
