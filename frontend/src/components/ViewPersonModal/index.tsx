  ...
  return (
    ...
    >
      ...
      <Container onSubmit={handleCloseAndResetPerson}>
        ...
        <input placeholder="Endereço" value={Endereco} disabled={true} />
        <input placeholder="Email" value={Email} disabled={true} />
        <input placeholder="Telefone" value={Telefone1} disabled={true} />
        <input
          placeholder="Contato 1"
          value={Telefone1Contato}
          disabled={true}
        />
        <input placeholder="Telefone 2" value={Telefone2} disabled={true} />
        <input
          placeholder="Contato 2"
          value={Telefone2Contato}
          disabled={true}
        />
        <input placeholder="Telefone 3" value={Telefone3} disabled={true} />
        <input
          placeholder="Contato 3"
          value={Telefone3Contato}
          disabled={true}
        />
        <input placeholder="Telefone 4" value={Telefone4} disabled={true} />
        <input
          placeholder="Contato 4"
          value={Telefone4Contato}
          disabled={true}
        />
        <input placeholder="Telefone 5" value={Telefone5} disabled={true} />
        <input
          placeholder="Contato 5"
          value={Telefone5Contato}
          disabled={true}
        />
        <input placeholder="Observações" value={Observacoes} disabled={true} />
